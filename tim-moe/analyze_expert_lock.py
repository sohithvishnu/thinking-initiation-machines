"""
Analysis for the MoE expert-locking intervention (tim-moe/moe_expert_lock.py).
...
Inputs: tim-moe/logs/moe_lock/eval_summary.json, answers_lock.jsonl
Output: prints the pass@1 table, paired contrasts, and behavioral stats;
        writes tim-moe/logs/moe_lock/analysis_summary.json
"""
